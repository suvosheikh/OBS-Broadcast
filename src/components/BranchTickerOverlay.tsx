...
export default function BranchTickerOverlay() {
  ...
  return (
    <div className="w-screen h-screen bg-transparent font-sans overflow-hidden relative flex items-center justify-center">
      {/* 16:9 Aspect Ratio Container */}
      <div className="w-full aspect-video relative flex flex-col justify-end max-h-screen">
        {/* Ticker Container */}
